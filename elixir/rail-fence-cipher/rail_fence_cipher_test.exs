...
defmodule RailFenceCipherTest do
  ...
  # @tag :pending
  test "encode example" do
    assert RailFenceCipher.encode("WEAREDISCOVEREDFLEEATONCE", 3) == "WECRLTEERDSOEEFEAOCAIVDEN"
  end
  ...
  # @tag :pending
  test "decode example" do
    assert RailFenceCipher.decode("WECRLTEERDSOEEFEAOCAIVDEN", 3) == "WEAREDISCOVEREDFLEEATONCE"
  end
